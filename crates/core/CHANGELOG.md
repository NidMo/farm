...
## [2.2.0](https://github.com/NidMo/farm/compare/farmfe_core-v2.1.0...farmfe_core-v2.2.0) - 2025-11-14

### Added

- *(core)* support umd & css.transformToScript ([#2254](https://github.com/NidMo/farm/pull/2254))
- add env manual control thread max nums ([#2249](https://github.com/NidMo/farm/pull/2249))

### Fixed

- reduce memory usage ([#2256](https://github.com/NidMo/farm/pull/2256))
