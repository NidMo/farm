...
## [2.0.2](https://github.com/NidMo/farm/compare/farmfe_plugin_script-v2.0.1...farmfe_plugin_script-v2.0.2) - 2025-11-14

### Other

- updated the following local packages: farmfe_core, farmfe_toolkit, farmfe_testing_helpers, farmfe_plugin_script_meta, farmfe_swc_transformer_import_glob
